...
int openMP_matrixMultiplication(float* matrix_A,int rows_A,int columns_A,
                                float* matrix_B,int rows_B,int columns_B,
                                float* matrix_C,int rows_C,int columns_C)
{
    const auto before = std::chrono::high_resolution_clock::now();
    ...
    const std::chrono::duration<double, std::milli> duration = std::chrono::high_resolution_clock::now() - before;
    std::cout << "openMP_matrixMultiplication took: " << duration.count() << " ms" << std::endl;
...
int openMP_matrixTranspose(float * A,int n,int m,float * A_transpose,int n_t,int m_t)
{
    const auto before = std::chrono::high_resolution_clock::now();
    ...
    const std::chrono::duration<double, std::milli> duration = std::chrono::high_resolution_clock::now() - before;
    std::cout << "openMP_matrixTranspose took: " << duration.count() << " ms" << std::endl;
